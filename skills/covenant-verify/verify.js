...
async function cloneRepo(url) {
    ...
    (0, child_process_1.execSync)(`git clone --depth 1 ${url} ${tmpDir}`, { timeout: 60000 });
    return tmpDir;
}
// ─── Main Verification ───────────────────────────────────────
async function verifyProject(repoUrl, requirements, depth = "standard") {
    ...
    // Cleanup
    try {
        (0, child_process_1.execSync)(`rm -rf ${repoDir}`);
    }
...
async function checkArchitecture(dir) {
    const issues = [];
    let score = 100;
    const hasSrc = (0, fs_1.existsSync)((0, path_1.join)(dir, "src")) || (0, fs_1.existsSync)((0, path_1.join)(dir, "app"));
    const hasTests = (0, fs_1.existsSync)((0, path_1.join)(dir, "test")) ||
        (0, fs_1.existsSync)((0, path_1.join)(dir, "tests")) ||
        (0, fs_1.existsSync)((0, path_1.join)(dir, "__tests__"));
    const hasDocs = (0, fs_1.existsSync)((0, path_1.join)(dir, "docs")) || (0, fs_1.existsSync)((0, path_1.join)(dir, "README.md"));
    const hasConfig = (0, fs_1.existsSync)((0, path_1.join)(dir, "package.json")) ||
        (0, fs_1.existsSync)((0, path_1.join)(dir, "tsconfig.json"));
    if (!hasSrc && !hasConfig) {
...
async function checkSecurity(dir) {
    ...
    if ((0, fs_1.existsSync)((0, path_1.join)(dir, ".env"))) {
...
async function checkPerformance(dir) {
    ...
    for (const bd of buildDirs) {
        const bdPath = (0, path_1.join)(dir, bd);
        if ((0, fs_1.existsSync)(bdPath)) {
...
async function checkTesting(dir) {
    ...
    const hasTests = (0, fs_1.existsSync)((0, path_1.join)(dir, "test")) ||
        (0, fs_1.existsSync)((0, path_1.join)(dir, "tests")) ||
        (0, fs_1.existsSync)((0, path_1.join)(dir, "__tests__")) ||
        (0, fs_1.existsSync)((0, path_1.join)(dir, "spec"));
    if (!hasTests) {
...
async function checkDocumentation(dir) {
    const issues = [];
    let score = 100;
    const readmePath = (0, path_1.join)(dir, "README.md");
    ...
    return {
        ...
        score: Math.max(0, score),
        details: `README: ${(0, fs_1.existsSync)(readmePath)}, Doc comments: ${docComments}`,
        issues,
        passed: score >= 70,
    };
}
async function checkDependencies(dir) {
    ...
    const hasLock = (0, fs_1.existsSync)((0, path_1.join)(dir, "package-lock.json")) ||
    ...
    return {
        ...
        score: Math.max(0, score),
        details: `Dependencies: ${(0, fs_1.existsSync)(pkgPath) ? "found" : "none"}, Lock file: ${hasLock}`,
        issues,
        passed: score >= 70,
    };
}
async function checkBestPractices(dir) {
    ...
    if ((0, fs_1.existsSync)((0, path_1.join)(dir, "tsconfig.json"))) {
        const tsconfig = JSON.parse((0, fs_1.readFileSync)((0, path_1.join)(dir, "tsconfig.json"), "utf-8"));
        if (!tsconfig.compilerOptions?.strict) {
            issues.push("TypeScript strict mode not enabled");
            score -= 10;
        }
    }
    const hasLint = (0, fs_1.existsSync)((0, path_1.join)(dir, ".eslintrc")) ||
        (0, fs_1.existsSync)((0, path_1.join)(dir, ".eslintrc.js")) ||
        (0, fs_1.existsSync)((0, path_1.join)(dir, ".eslintrc.json")) ||
        (0, fs_1.existsSync)((0, path_1.join)(dir, "eslint.config.js"));
    if (!hasLint) {
    ...
    return {
        ...
        score: Math.max(0, score),
        details: `Gitignore: ${(0, fs_1.existsSync)((0, path_1.join)(dir, ".gitignore"))}, Lint: ${hasLint}`,
        issues,
        passed: score >= 70,
    };
}
