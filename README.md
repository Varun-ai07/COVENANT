...
│   │   │   ├── useVerifier.ts             # Verifier contract interactions
│   │   │   ├── useGetSubmittedTasks.ts
│   │   │   ├── useRegisterVerifier.ts
│   │   │   ├── useCreateVerificationReceipt.ts
│   │   │   ├── useStakeOnVerification.ts
│   │   │   └── useChallengeVerification.ts
...
| Lit Protocol | Threshold Encryption & Access Control |
