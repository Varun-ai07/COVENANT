...
import type { TaskListing, Bid, TaskMatch, TaskMetadata } from "../types.js";
import { loadStore, saveStore } from "../persistence.js";

export class OpenTaskMarket {
  private listings: Map<string, TaskListing>;
  ...
  static CATEGORIES = ["development", "data-analysis", "content-creation", "design", "testing", "research", "translation", "marketing"];
  static MIN_BID_DURATION = 24 * 60 * 60;
  static MAX_BID_DURATION = 90 * 24 * 60 * 60;
  ...
  constructor(config: { identityAddress: Address; identityAbi: any; publicClient: PublicClient }) {
    ...
    this.listings = new Map(Object.entries(loadStore("market_listings", {})));
    this.bids = new Map(Object.entries(loadStore("market_bids", {})));
    this.listingCounter = loadStore("market_listing_counter", 0);
    this.bidCounter = loadStore("market_bid_counter", 0);
  }
  ...
  async postTask(
    ...
    this.listingCounter++;
    saveStore("market_listing_counter", this.listingCounter);
    ...
    saveStore("market_listings", Object.fromEntries(this.listings));
    saveStore("market_listings", Object.fromEntries(this.listings));
    return listing;
  }
  ...
  submitBid(
    ...
    this.bidCounter++;
    saveStore("market_bid_counter", this.bidCounter);
