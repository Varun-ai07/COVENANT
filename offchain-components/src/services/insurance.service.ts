...
export class InsuranceService {
  ...
  private claims: Map<string, InsuranceClaim>;
  ...
  constructor(config: { identityAddress: Address; identityAbi: any; publicClient: PublicClient }) {
    ...
    this.policies = new Map(Object.entries(loadStore("insurance_policies", {})));
    this.claims = new Map(Object.entries(loadStore("insurance_claims", {})));
    this.claimCounter = loadStore("insurance_claim_counter", 0);
  }
  ...
  async enroll(agent: Address, premium: bigint): Promise<InsurancePolicy> {
    ...
    saveStore("insurance_policies", Object.fromEntries(this.policies));
    return policy;
  }
  ...
  submitClaim(
    ...
    saveStore("insurance_claims", Object.fromEntries(this.claims));
    saveStore("insurance_claim_counter", this.claimCounter);
    return claim;
  }
