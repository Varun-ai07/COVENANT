...
export class CapabilityManager {
  ...
  private capabilities: Map<string, DelegatedCapability>;
  ...
  constructor(config: CapabilityConfig) {
    ...
    this.capabilities = new Map(Object.entries(loadStore("capabilities", {})));
  }
  ...
  grantCapability(
    ...
    saveStore("capabilities", Object.fromEntries(this.capabilities));
    return key;
  }
